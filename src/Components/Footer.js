const Footer = () => {
  return (
    ...
    //   <div className="container px-5 py-24 mx-auto flex flex-col items-center md:flex-row md:flex-nowrap md:items-start">
    ...
    //       </a>
    //     </div>
    //     <div className="flex-grow flex flex-wrap justify-center sm:w-[300px] md:pl-20 -mb-10 md:mt-0 mt-10 text-center md:text-left">
    ...
    //           </li>
    //           <li>
    //             <a className="text-gray-600 hover:text-gray-800">9967362908</a>
    //           </li>
    //           <li>
    //             <a className="text-gray-600 hover:text-gray-800">8422088422</a>
    //           </li>
    //         </nav>
    //       </div>
    //       <div className="lg:w-1/4 md:w-1/2 w-full px-4">
    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto flex flex-col items-center md:flex-row md:flex-nowrap md:items-start">
        ...
        <div className="flex-grow flex flex-wrap justify-center md:justify-start md:pl-20 -mb-10 md:mt-0 mt-10 text-center md:text-left">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
              PRODUCT
            </h2>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-col sm:flex-row items-center justify-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-left text-center sm:ml-0 sm:mt-0 mt-4">
            © 2024 Kamero — All Rights Reserved
          </span>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
